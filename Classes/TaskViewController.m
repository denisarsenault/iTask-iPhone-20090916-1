...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    if (self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil]) {
		...
		if(!deleteButton){
			UIImage* deleteTaskImage  = [UIImage imageNamed:@"deletetask.png"];
			
			deleteButton = [[UIButton alloc]initWithFrame:CGRectMake(10,0,300,44)];
			[deleteButton setBackgroundImage:deleteTaskImage forState:UIControlStateNormal];
...
//
// Response for the dialog for deleting the currently edited task in the AddTaskViewController
//
